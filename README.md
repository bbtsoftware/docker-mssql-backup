...
| CRON_LOG_SIZE_LIMIT  | `10MB`        | Size limitation of cron log file `/var/log/cron.log`. If the variable is empty, the log file will not be reduced. Information about the supported `--size` Units are [here](https://man7.org/linux/man-pages/man1/truncate.1.html) |
